<?php
    ...
    $vendas = DaoVenda::listarCanceladas($cliente);
          ...
          <header class="avatar">
            ...
            <div class="sidebar-options">
                ...
                <div class="li-back-ativo">
                    <a href="#"><li class="span__sidebar">Canceladas</li></a>
                </div>
            </div>
        </nav>
                        ...
                        <div class="card-body">
                            <div class="about__container  bd-grid">
                                <div class="about__data">
                                    ...
                                    <h2 class="section-title">Cancelado</h2>
                                    <p class="about__description black"><?php if($venda['statusVenda'] == 4 ) { echo 'Cancelado por você'; } else { echo 'Cancelado pela administração'; } ?></p>
                                    <?php if ($venda['statusVenda'] == 1) { ?> <a href="../control/cancelar-pedido.php?id=<?php echo $venda['codVenda']; ?>"><button class="button size">Cancelar pedido</button></a> <?php } ?>
                                </div>
                                <img src="../assets/img/cancelado.png" class="about__img">
                            </div>
                            <table class="table">
                                <thead>
                                    <tr>
