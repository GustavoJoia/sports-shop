<?php
    ...
    $vendas = DaoVenda::listarAndamento($cliente);
        ...
        <header class="l-header" id="header">
            <nav class="nav home-container fixed-top">
                ...
                <div class="align-info">
                    ...
                    <?php
                            ...
                            <a href="#" class="drop_a disable">Meus pedidos</a>
          ...
          <div class="sidebar-options">
                <div class="li-back-ativo">
                    <a href="#"><li class="span__sidebar">Em andamento</li></a>
                </div>
                <div class="li-back">
                    <a href="vendasConfirmadas.php"><li class="span__sidebar">Finalizadas</li></a>
                </div>
                <div class="li-back">
                                    ...
                                    <?php
                                        ...
                                        switch($venda['statusVenda']){
                                            case 1:
                                                ...
                                                $mensagem = 'Aguardando verificação por parte do administrador';
                                                $foto = '../assets/img/aguardando.png';
                                            case 2:
                                                $status = 'Em Preparo';
                                                $mensagem = 'Já estamos organizando seus produtos para enviar o mais rápido possível!';
                                                $foto = '../assets/img/preparo.png';
                                            case 3:
                                                $status = 'Saiu para a entrega';
                                                $mensagem = 'Sua compra já está indo em direção à sua casa!';
                                                $foto = '../assets/img/entrega.png';
                                        }
                                    ?>
                                    <h2 class="section-title"><?php if($venda['statusVenda'] == 1 ) { echo 'Aguardando Confirmação'; } else if($venda['statusVenda'] == 2 ) { echo 'Em Preparo'; } else if($venda['statusVenda'] == 3 ){ echo 'Saiu para a entrega'; } ?></h2>
                                    <p class="about__description black"><?php if($venda['statusVenda'] == 1 ) { echo 'Aguardando verificação por parte do administrador'; } else if($venda['statusVenda'] == 2 ) { echo 'Já estamos organizando seus produtos para enviar o mais rápido possível!'; } else if($venda['statusVenda'] == 3 ){ echo 'Sua compra já está indo em direção à sua casa!'; } ?></p>
                                    <?php if ($venda['statusVenda'] == 1) { ?> <a href="../control/cancelar-pedido.php?id=<?php echo $venda['codVenda']; ?>"><button class="button size">Cancelar pedido</button></a> <?php }else if($venda['statusVenda'] == 3 ){ ?><a href="../control/confirmar-pedido.php?id=<?php echo $venda['codVenda']; ?>"><button class="button size">Confirmar Entrega</button></a><?php } ?>
                                </div>
                                <img src="<?php if($venda['statusVenda'] == 1 ) { echo '../assets/img/aguardando.png'; } else if($venda['statusVenda'] == 2 ) { echo '../assets/img/preparo.png'; } else if($venda['statusVenda'] == 3 ){ echo '../assets/img/entrega.png'; } ?>" class="about__img">
                            </div>
                            <table class="table">
                                <thead>
                                    <tr>
