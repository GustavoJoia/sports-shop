...
<html lang="pt-BR">
    ...
    <body>
        ...
        <main>
            <div class="card-flex">
                <a href="#cadastrados" class="nav-link button side nav-green">Categorias cadastradas</a>
            </div>
                <div class="card-body">
                    ...
                    <div class="home__container bd-container bd-grid">
                            <div class="home__data">
                                <h2 class="home__subtitleAlt">Cadastro de categoria</h2>
                                    <br>
                                    <form name="formularioProduto" action="../control/cadastra-categoria.php" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                    ...
                    <h2 class="section-title-alt form-produto" style="margin-top: 10vh">Categorias cadastradas</h2>
                        ...
                        <section class="section__cadastrados" id="cadastrados">
                            ...
                            <tbody>
                                ...
                                $categorias = DaoCategoria::listar(0);
                                
                                foreach($categorias as $categoria){ ?>
                                    <tr>
                                        <th class="align-middle" scope="row"><?php echo $categoria['codCategoria']; ?></th>
                                        <td> <img src="<?php echo '../'.$categoria['fotoCategoria']; ?>" class="rounded" width="20%"></td>
                                        <td class="align-middle"><?php echo $categoria['nomeCategoria']; ?></td>
                                        <td class="align-middle"><?php echo $categoria['descCategoria']; ?> </td>
                                        <td class="align-middle"><a href="edicaoCategoria.php?id=<?php echo $categoria['codCategoria']; ?>" class="nav-green nav-color">Editar</a></a>
                                        <td class="align-middle"><a href="../control/excluir-categoria.php?id=<?php echo $categoria['codCategoria'] ?>" class="nav-red nav-color">Excluir</a></a>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </section>
