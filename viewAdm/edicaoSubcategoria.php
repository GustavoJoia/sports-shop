<?php 
    ...
    $lista = DaoSubcategoria::listarEspecifico($subcategoria);
?>
...
<html lang="pt-BR">
    <head>
        ...
        <title>ADM - Editar SubCategoria</title>
    </head>
                ...
                <div class="card-body">
                    ...
                    <div class="home__container bd-container bd-grid">
                            <div class="home__data">
                                <h2 class="home__subtitleAlt">Editando: <?php echo $lista['nomeSubCategoria']; ?></h2>
                                <p>O campo que não for preenchido será mantido conforme valor da última atualização</p>
                                    <br>
                                    <form name="formularioProduto" action="../control/edita-subcategoria.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label>Nome da Subcategoria:</label>
                                            <input type="text" name=txt_nomeCategoria class="form-control form-border" id="formGroupExampleInput" placeholder="<?php echo $lista['nomeSubCategoria']; ?>">
                                            <label>Breve Descrição:</label>
                                            <input type="text" name=txt_descCategoria class="form-control form-border" id="formGroupExampleInput" placeholder="<?php echo $lista['descSubCategoria']; ?>"> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col"><a class="nav-link button btn-cancelar nav-red" href="cadastroSubcategoria.php#cadastrados">Cancelar</a></div>
                                        </div>
                                    </form>       
                            </div>
                    </div>
